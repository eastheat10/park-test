...
class FeePolicy1Test {
    ...
    void parking_30m() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(1_000));
    }
    ...
    void parking_31m() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(1_500));
    }
    ...
    void parking_61m() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(3_000));
    }
    ...
    void parking_6h() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(10_000));
    }
    ...
    void parking_2days() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(20_000));
    }
    ...
    void parking_3days() {
        ...
        assertThat(policy.calculateFee(enterTime, exitTime, 0)).isEqualTo(BigDecimal.valueOf(30_000));
    }
